...
namespace FairyLink.Actor
{
    ...
    class Enemy_Slime : Character
    {
        ...
        public Enemy_Slime(Stage stage, Vector2 position, int speedX, Direction direction, CharacterControl characterControl, EffectControl effectControl, GameDevice gameDevice)
            : base("enemy_slime_fire", new Vector2(96, 96), new Vector2(48, 48), stage, characterControl, effectControl, gameDevice)
        {
        ...
        private void UpdateMotion() {
            ...
            if (speed.X != 0 && mode != ActionMode.MOVE && mode != ActionMode.DEATH) { 
                ...
                motion.Initialize(new Range(1, 2), timer); 
            }
